...
@Tag("testshop")
@Feature("Log in func")
@Story("develop login func of api and ui")
@Severity(SeverityLevel.BLOCKER)
@DisplayName("Api test suite")

public class DemoWebShopTests extends TestBase{

    static UserConfigOwner userConfig = ConfigFactory
            .create(UserConfigOwner.class);
    static String login = userConfig.userLogin(),
            password = userConfig.userPassword(),
            authCookieName = userConfig.authCookie();
    ...
    void loginWithApiTest() {
        step("Get cookie by api and set it to browser", () -> {
            String authCookieValue = given()
                    ...
                    /* Один из вариантов прописать значения
